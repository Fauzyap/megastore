...
<link rel="stylesheet" type="text/css" href="css/stylepembayaran8ball.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/8ballround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">8 Ball Pool</div>
            <hr size="5px">
            <div class="content_product_name">
            Eight Ball adalah permainan call shot yang dimainkan dengan sebuah cue ball dan lima belas bola objek, bernomor 1 sampai 15. Satu pemain harus mengantongi bola kelompok bernomor 1 sampai 7 (warna solid), sedangkan pemain lainnya memiliki 9 sampai 15 (garis-garis) .
            </div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <div class="form-field-wrapper form__field-user-id">
                <input name="moonton.userId" type="tel" class="userid form-input" placeholder="Masukkan Unique ID" maxlength="10">
             </div>
