...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranla.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/laround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Life After</div>
            <hr size="5px">
            <div class="content_product_name">
            LifeAfter adalah survival game dengan latar masa depan. Dalam game ini, para pemain dituntut untuk bertahan di tengah kehancuran dunia karena Zombie Apocalypse. Badai virus membuat dunia berubah menjadi neraka yang mengerikan. 
            <br>
            Untuk tetap hidup, kamu harus membangun rumah dan mencari senjata terbaik. Saatnya menunjukkan kemampuanmu bertahan di tengah situasi yang tidak menguntungkan melalui game LifeAfter yang seru.
            </div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <div class="form-field-wrapper form__field-user-id">
                <input name="moonton.userId" type="tel" class="userid form-input" placeholder="Masukkan Account ID" maxlength="10">
             </div>
             ...
             <p class="form__field-instruction-text">Untuk menemukan Account ID Anda, buka aplikasi LifeAfter, lalu klik pengaturan yang terletak di kanan atas layar game dan Account ID akan terlihat. Silakan masukan Account ID Anda disini</p>
