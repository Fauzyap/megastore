...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranazure.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/azurround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Azur Lane</div>
            <hr size="5px">
            <div class="content_product_name">
            Azur Lane adalah video game side-scrolling shoot 'em up, simulasi dan role-playing. 
            Pemain mengumpulkan karakter yang merupakan interpretasi antropomorfik moe dari kapal perang Perang Dunia II ("shipgirls"), terutama dari Angkatan Laut Amerika Serikat, Angkatan Laut Kerajaan, Angkatan Laut Kekaisaran Jepang dan Kriegsmarine, dengan kapal-kapal lain dari Angkatan Laut Prancis (baik rasa Vichy dan Free France) , Angkatan Laut Republik China, Angkatan Laut Tentara Pembebasan Rakyat, Regia Marina, Angkatan Laut Soviet dan Angkatan Laut Kekaisaran Rusia akan ditambahkan kemudian. Pemain mengatur mereka menjadi enam armada dan menghadapi musuh yang dikendalikan AI atau armada pemain lain.</div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <div class="form-field-wrapper form__field-user-id">
                <input name="moonton.userId" type="tel" class="userid form-input" placeholder="Masukkan UID" maxlength="10">
             </div>
            ...
            <div class="img-helper">
             ...
             <p class="form__field-instruction-text">Untuk menemukan Unique ID Anda, silahkan klik foto profil Anda
                Di dalam profil, tepatnya di pojok kanan atas layar, Anda dapat menemukan Unique ID Anda. Harap hilangkan tanda hubung (-) yang terdapat pada Unique ID Anda
                Contoh: "1234567890"
