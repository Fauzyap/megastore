...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranhi.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/hiround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Honkai Impact 3rd</div>
            <hr size="5px">
            <div class="content_product_name">
            Tentang Honkai Impact 3rd :
            Honkai Impact 3 atau adalah game free-to-play aksi permainan peran 3D mobile game yang dikembangkan oleh miHoYo. Merupakan seri ketiga dari Seri Honkai dan kelanjutan dari Houkai Gakuen, menggunakan banyak karakter yang sama dari judul sebelumnya, dengan cerita baru yang terpisah.</div>
        </section>
