...
<link rel="stylesheet" type="text/css" href="css/stylepembayarangenshin.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/genshinround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Genshin Impact</div>
            <hr size="5px">
            <div class="content_product_name">
            Tentang Genshin Impact :
            Teyvat, sebuah dunia fantasi yang bebas, dinamis, dan penuh dengan kehidupan mistis, dunia di mana tujuh elemen yang saling mengalir, berpadu, menari dan beradu.<br><br>

            Pemain berperan sebagai seorang dari sepasang saudara kembar yang berkelana dari dunia satu ke dunia lain. Sampai sesosok dewa yang tak dikenal menghadang langkahmu, merenggut saudara kembarmu, dan menyegel kekuatanmu. Karena sihirnya, kamu tertidur tak sadarkan diri.<br><br>

            Saat kesadaranmu kembali, dunia di sekelilingmu... bukan lagi dunia yang kamu kenal.</div>
        </section>
...
<div class="logo1">
    <img src="../../public/images/telf.png">
</div>
<div class="logo2">
    <img src="../../public/images/telf.png">
</div>
