...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranmarvel.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/marvelround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Marvel Super War</div>
            <hr size="5px">
            <div class="content_product_name">
            Game MOBA pertama Marvel di ponsel! Marvel dan NetEase Games telah bekerja sama untuk menghadirkan rekreasi Marvel Universe yang paling dinamis, memukau, dan setia di layar kecil. Bersiaplah untuk menjelajahi lebih banyak kemungkinan dan mengalami aksi yang belum pernah ada sebelumnya!</div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <p class="form__field-instruction-text">Untuk menemukan ID Anda, buka aplikasi Marvel Super War, klik pada ikon avatar yang terletak di pojok kiri atas layar lalu klik pada tombol kode QR, ID dapat Anda temukan disana. Silakan masukan ID Anda di sini.!</p>
