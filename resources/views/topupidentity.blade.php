...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranidentity.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/identityround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Identity V</div>
            <hr size="5px">
            <div class="content_product_name">
            Identity V adalah game horor bertahan hidup. Dengan gaya seni gothic, alur cerita misterius, dan gameplay 1vs4 yang menarik, game ini akan memberi Anda pengalaman yang menakjubkan. Anda pertama-tama akan memasuki permainan sebagai detektif, yang telah menerima surat undangan misterius. Surat itu meminta Anda untuk pergi ke manor yang ditinggalkan dan mencari seorang gadis yang hilang. Selama proses investigasi, Anda harus mendapatkan petunjuk dengan memainkan Hunter atau Survivor. Dan saat Anda semakin dekat dengan kebenaran, Anda menemukan sesuatu yang mengerikan!
            </div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <p class="form__field-instruction-text">1. Masuk ke dalam game dan pilih tombol teman di kanan atas 2. Pergi ke \\\'Profile' tab 3. Nomor yang terdapat di dalam area merah pada gambar adalah User ID</p>
