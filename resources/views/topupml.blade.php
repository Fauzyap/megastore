...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranml.css">
<link rel="stylesheet" type="text/css" href="css/nvftml.css">
...
<body>
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/mlround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Mobile Legends</div>
            <hr size="5px">
            <div class="content_product_name">
                Tentang Mobile Legends :<br/>
                Mobile Legends merupakan game MOBA yang dikembangkan oleh Moonton dan telah menjadi game paling populer saat ini. Game Mobile Legends bisa dimainkan oleh 10 orang yang terbaik ke dalam dua tim. Beli miliki hadiah Anggota Starlight, Twilight Pass, skin favorit ada champion favorit Anda dengan diamond ML (Mobile Legends)! Yang harus kamu lakukan hanya top up diamond ML pakai pulsa Telkomsel, XL, Tri & Smartfren.
            </div>
        </section>
                    ...
                    <li id="paymentChannel_230" class="payment-channel-element">
                        <a class="payment-channel-link" onclick="selectPaymentChannel(230, 'OVO', false, false, false);">
                            ...
                            <p><img class="logo" id="payment-logo_227" src="images/outline_smartphone_black_24dp.png"style="float:left;">SMS & Seluler</p>
                                    ...
                                    <div class="row">
                                    <div class="col col-lg-4">
                                            <img class="logoEWALLET" id="payment-logo_227" src="images/logo-tsel.png" alt="GO_PAY logo">
                                        </div>
                                         <div class="col col-lg-2">
