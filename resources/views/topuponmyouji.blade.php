...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranonmy.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/onmyoujiround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Onmyouji Arena</div>
            <hr size="5px">
            <div class="content_product_name">
            Onmyoji Arena adalah game MOBA seluler yang dikembangkan oleh NetEase Games.
            <br>
            Gim ini mempertahankan estetika Jepang yang elegan dan bakat suara asli untuk dengan setia menciptakan kembali Kyoto di era Heian. Dengan desain peta yang inovatif, mode Fog of War, dan serangkaian keterampilan Shikigami yang lebih besar, pemain berada dalam tantangan yang lebih menyenangkan dan lebih besar saat mereka berjuang untuk menjadi yang tertinggi. Sistem amulet berbayar kini digantikan oleh sistem Onmyodo gratis. Ini meratakan lapangan permainan. Pemain dari seluruh dunia terhubung, dan Battle Royale 3v3v3 yang semuanya baru akan memberi pemain pengalaman MOBA yang menyenangkan dan baru.</div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
            ...
            <div class="img-helper">
             ...
             <p class="form__field-instruction-text">Untuk menemukan Player ID Anda, buka aplikasi Onmyoji Arena dan masuk. Klik pada potret karakter Anda yang terletak di sisi kiri atas layar, kemudian klik pada icon QR di sisi kanan atas layar dan Player ID Anda akan ditampilkan. Masukkan Player ID Anda di sini.</p>
