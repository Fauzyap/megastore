...
<link rel="stylesheet" type="text/css" href="css/stylepembayaransultan.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/sultanround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Game of Sultans</div>
            <hr size="5px">
            <div class="content_product_name">
            Game of Sultans adalah game simulasi RPG kerajaan baru yang mengasyikkan di mana Anda bisa mengalami kehidupan seorang Sultan - raja Eropa dan Timur Tengah! Setiap detail telah diperhatikan sehingga pemain dapat membenamkan diri dalam perang brutal, strategi militer, romance genit, manajemen kerajaan, intrik politik, dan banyak lagi!</div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <div class="form-field-wrapper form__field-user-id">
                <input name="moonton.userId" type="tel" class="userid form-input" placeholder="Masukkan ID" maxlength="10">
             </div>
             <div class="img-helper__background"></div>
             <p class="form__field-instruction-text">Untuk menemukan ID Anda, ketuk ikon di kiri atas halaman utama. Anda bisa menemukan ID Anda dibawah gambar profile. Mohon masukan ID yang lengkap disini.
