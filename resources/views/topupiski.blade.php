...
<link rel="stylesheet" type="text/css" href="css/stylepembayaraniski.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/iskiround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Island King</div>
            <hr size="5px">
            <div class="content_product_name">
            Island King adalah permainan slot berbasis mobile yang diterbitkan oleh Forever9 Games. Dalam permainan ini kamu dapat memutar slot, menyerang dan mencuri dari pulau orang lain, dan mengumpulkan kartu-kartu untuk dikoleksi dan ditukarkan dengan hadiah. Kini itemku menyediakan Top Up Koins dan Putar untuk berbagai aktivitas kamu di Island King.
            </div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <div class="form-field-wrapper form__field-user-id">
                <input name="moonton.userId" type="tel" class="userid form-input" placeholder="Masukkan Role ID" maxlength="10">
             </div>
