...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranchess.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/chessround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Auto Chess</div>
            <hr size="5px">
            <div class="content_product_name">
            Auto Chess adalah game strategi online multipemain baru yang sangat kompetitif yang dibuat oleh Drodo dan Dragonest Co.Ltd, dirilis dan didukung secara teknis oleh Dragonest Co.Ltd. Pemain akan membangun sistem ekonomi mereka sendiri dan menggunakan unit unik untuk bertarung satu sama lain dalam skenario 8 pemain last man standing. Letakkan keterampilan strategi Anda melawan 7 pemain lain secara bersamaan dan buktikan keterampilan Anda untuk menyesuaikan strategi Anda secara real-time. ImbaTV akan mengelola turnamen eSports global Auto Chess. Dari mana pun Anda berasal, Anda dapat menantang pemain top dari seluruh dunia. Liga eSports Auto Chess top dunia sedang menunggu Anda!
            </div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <p class="form__field-instruction-text">1. Masuk ke beranda<br>
                2. Pilih "Avatar" yang berada di pojok kiri atas layar<br>
                3. Cek player ID Anda di Informasi Personal</p>
