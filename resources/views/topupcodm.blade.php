...
<link rel="stylesheet" type="text/css" href="css/stylepembayarancodm.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/codmround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">COD : Mobile</div>
            <hr size="5px">
            <div class="content_product_name">
            Top up CALL OF DUTY MOBILE hanya dalam hitungan detik! Cukup masukan OPENID Anda, pilih jumlah NOMINAL yang Anda inginkan, selesaikan pembayaran, dan Diamond akan secara langsung ditambahkan ke akun Mobile Legends Anda. Bayarlah menggunakan GoPay, ShopeePay, Dana, OVO, LinkAja, Telkomsel, Indosat, Tri, XL, Bank Transfer, Indomaret, Alfamart, Kredivo, TrueMoney Indonesia, Kartu Kredit, dan Doku Wallet. Tanpa perlu kartu kredit, registrasi ataupun log-in.</div>
        </section>
