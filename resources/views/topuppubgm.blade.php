...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranpubgm.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/pubgmround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">PUBG : Mobile</div>
            <hr size="5px">
            <div class="content_product_name">
            Top up PUBG MOBILE hanya dalam hitungan detik! Cukup masukan USERID Anda, pilih jumlah NOMINAL yang Anda inginkan, selesaikan pembayaran, dan Diamond akan secara langsung ditambahkan ke akun Mobile Legends Anda. Bayarlah menggunakan GoPay, ShopeePay, Dana, OVO, LinkAja, Telkomsel, Indosat, Tri, XL, Bank Transfer, Indomaret, Alfamart, Kredivo, TrueMoney Indonesia, Kartu Kredit, dan Doku Wallet. Tanpa perlu kartu kredit, registrasi ataupun log-in.</div>
        </section>
