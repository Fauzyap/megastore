...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranhido.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/hidoround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">Higgs Domino</div>
            <hr size="5px">
            <div class="content_product_name">
            Higgs Domino Island adalah sebuah permainan domino yang berciri khas lokal terbaik di di Indonesia.
            <br>
            Ini adalah permainan yang unik dan menarik, ada Domino Gaple, Domino QiuQiu dan banyak lagi permainan yang membuat waktu luangmu semakin menyenangkan.
            <br>
            Beli Koin Emas-D Higgs Domino di UniPin, sekarang juga!</div>
        </section>
