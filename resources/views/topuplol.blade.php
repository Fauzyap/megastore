...
<link rel="stylesheet" type="text/css" href="css/stylepembayaranlol.css">
...
<div class="container product-container">
    ...
    <div class="searchh">
        ...
        <section class="product-details-container">
            <div class="product-top-banner__container"><img src="images/lolround.png" alt="" class="product__top-banner"></div>    
            <div class="product__name">LOL : Wild Rift</div>
            <hr size="5px">
            <div class="content_product_name">
            League of Legends: Wild Rift adalah game mobile arena pertempuran online multipemain yang dikembangkan dan diterbitkan oleh Riot Games untuk Android dan iOS. Game gratis untuk dimainkan ini adalah versi modifikasi dari game PC League of Legends.
            </div>
        </section>
    ...
    <div class="section select-server" style="font-family:Myriad Pro;margin-top:460px;margin-left:45px;width:740px;">
        ...
        <div class="form-group-container form-user-identities">
             ...
             <div class="form-field-wrapper form__field-user-id">
                <input name="moonton.userId" type="tel" class="userid form-input" placeholder="Masukkan RIOT ID" maxlength="10">
             </div>
             <div class="form-field-wrapper form__field-zone-id ">
                <input name="moonton.zoneId" type="tel" class="zoneid form-input enable" placeholder="#" maxlength="5">
            </div>

             <div class="img-helper__background"></div>
             <p class="form__field-instruction-text">Untuk menemukan Riot ID Anda, buka halaman profil akun dan salin Riot ID+Tag menggunakan tombol yang tersedia disamping Riot ID. (Contoh: Westbourne#SEA)</p>
